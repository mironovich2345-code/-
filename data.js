...
window.PROJECTS = [
  {
    ...
    screenshots: [
      { src: "assets/eatly-dashboard.png", alt: { ru: "Главный экран дневника", en: "Diary home screen" } },
      { src: "assets/eatly-analysis.png", alt: { ru: "AI-анализ фото блюда", en: "AI photo analysis" } },
      { src: "assets/eatly-stats.png", alt: { ru: "Статистика и вес", en: "Stats and weight" } },
    ],
    cover: { kind: "diary" },
  },
  {
    ...
    screenshots: [
      { src: "assets/trainer-experts.png", format: "desktop", alt: { ru: "Кабинет эксперта", en: "Expert dashboard" } },
      { src: "assets/trainer-landing.png", format: "desktop", alt: { ru: "Лендинг для тренеров", en: "Landing for trainers" } },
      { src: "assets/trainer-howto.png",   format: "desktop", alt: { ru: "Как это работает", en: "How it works" } },
    ],
    cover: { kind: "trainers" },
  },
  {
